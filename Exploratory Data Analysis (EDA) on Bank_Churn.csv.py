# Bank Customer Churn Analysis - Enhanced EDA Version
...
numeric_data = data_encoded.select_dtypes(include=[np.number]).dropna()
...
age_churn = data.groupby("AgeGroup")["Exited"].mean() * 100
